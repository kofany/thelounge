...
class Uploader {
	...
	uploadNextFileInQueue(token: string) {
		...
		// This issue only happens if Nexus Lounge is proxied through other software
		// as it may buffer the upload before the upload request will be processed by Nexus Lounge.
