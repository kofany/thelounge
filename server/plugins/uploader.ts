...
const nativeIsUtf8 = (Buffer as typeof Buffer & {
    isUtf8?: (input: ArrayBufferView | ArrayBuffer) => boolean;
}).isUtf8;

const isUtf8Buffer = (buffer: Uint8Array) => {
    if (typeof nativeIsUtf8 === "function") {
        return nativeIsUtf8(buffer);
    }
