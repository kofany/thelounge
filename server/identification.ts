...
class Identification {
	...
	refresh() {
		let file = "# Warning: file generated by Nexus Lounge: changes will be overwritten!\n";
		...
		this.connections.forEach((connection, id) => {
			if (!connection.socket.remotePort || !connection.socket.localPort) {
				...
				log.warn(
					`oidentd: socket has no remote or local port (id=${id}). See https://github.com/nexuslounge/nexuslounge/pull/4695.`
				);
				return;
			}
